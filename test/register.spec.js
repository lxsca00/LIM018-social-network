...
describe('fEventRegister funciona correctamente', () => {
  ...
  it('debería aparecer error cuando los datos son vacios', (done) => {
    ...
    btnRegister.click();
    setTimeout(() => {
      expect(document.querySelector('.register-error').innerHTML).toBe('Proporcione una dirección de correo válida.');
      done();
    });
  });
  ...
  it('debería aparecer error cuando no se ingresa contraseña', (done) => {
    ...
    btnRegister.click();
    setTimeout(() => {
      expect(document.querySelector('.register-error').innerHTML).toBe('El ingreso de contraseña es obligatorio.');
      done();
    });
  });
  ...
  it('debería aparecer error cuando ingresa contraseña menor a 6 dígitos', (done) => {
    ...
    btnRegister.click();
    setTimeout(() => {
      expect(document.querySelector('.register-error').innerHTML).toBe('Tu contraseña debe tener al menos 6 caracteres.');
      done();
    });
  });
